...
// We can make any changes we want to the implementation class without triggering
// a recompile of other source files that include Sandwich.h since SandwichImpl 
// is only defined here in this source file and thus only this source file needs 
// to be recompiled if we make changes to SandwichImpl.
class SandwichImpl
{
public:
	SandwichImpl();
